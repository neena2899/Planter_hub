    ...
    <div class="container">
      <div class="header-container d-flex align-items-center">
        <div class="logo mr-auto">
          <h1 class="text-light"><a href="index.php"><span>PLANTER HUB</span></a></h1>
...
<li class="drop-down <?php
  ...
  <ul>
    ...
    <li><a href="viewpurchaserequest.php">View Planter Produce Purchase request</a></li>
    <li><a href="viewcstpurchaseorder.php">View Planter Produce Purchase Order</a></li>
...
<li class="drop-down <?php
                            ...
                            ?>" ><a href="">My Account</a>
  <ul>
	<li><a href="sellerpanel.php">Planter's Panel</a></li>
	...
	<li class="drop-down"><a href="#">Plantation Sales Report</a>
  <ul>
...
{
?>
<li class="drop-down"><a href="">SIGN-IN/UP</a>
  <ul>
	<li><a href="customerreglogin.php">Customer Account</a></li>
	<li><a href="sellerreglogin.php">Planter Account</a></li>
  <li><a href="workerreglogin.php"> Worker Account</a></li>
  </ul>
</li>
<?php
}
