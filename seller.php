...
if(isset($_POST['submit']))
{
	...
	{
$sql="INSERT INTO seller(seller_name, seller_address, state_id,  city_id, pincode, contact_number, mobile_no, email_id, password, bank_name, bank_branch, bank_IFSC, bank_acno, status) VALUES ('$_POST[sellername]','$_POST[selleraddress]','$_POST[state]','$_POST[city]','$_POST[pincode]','$_POST[contactnumber]','$_POST[mbnumber]','$_POST[emailid]','$_POST[password]','$_POST[bankname]','$_POST[branch]','$_POST[ifsccode]','$_POST[bankacnumber]','Active')";	
	if(!mysqli_query($con,$sql))
		{
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Planter Registration Panel</h2>
          <ol>
            ...
            <div class="row">
              ...
              <div class="col-md-3 d-flex align-items-stretch mt-4 mt-lg-0">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="200" style="width: 100%;">
                  <h4>Register as Planter</h4>
                  <img src="images/icon1.jfif" style="width: 100%;">
                </div>
              </div>
...
<div class="form-row">
	...
	Pincode <font color="#FF0000"> *</font>
	  <input type="text" name="pincode" id="pincode" value="<?php echo $rsedit['pincode']; ?>" class="form-control">
	</div>
	
	<div class="col-md-6 form-group">
	Contact Number <font color="#FF0000"> *</font>
	  <input type="text" name="contactnumber" id="contactnumber" value="<?php echo $rsedit['contact_number']; ?>" class="form-control">
	</div>
	
	<div class="col-md-6 form-group">
	Mobile Number <font color="#FF0000"> *</font>
	  <input type="text" name="mbnumber" id="mbnumber" value="<?php echo $rsedit['mbnumber']; ?>" class="form-control">
	</div>
...
?>
	<script type="application/javascript">
		var alphaExp = /^[a-zA-Z]+$/; //Variable to validate only alphabets
				...
				var numericExpress = /^\d{6}$/; //Variable to validate pincode only numbers
	  ...
	  function validate1()
	  {
		...
		if(document.frmsellreg.sellername.value == "")
		  ...
		  else if(document.frmsellreg.sellername.value == 'null')
				{
					alert("Seller name should not be empty");
					document.frmsellreg.sellername.focus();
					return false;
	  ...
	  function validate2()
	  {
		...
		if(select2.value==null)
				...
				else if(!document.frmsellreg.pincode.value.match(numericExpress))
				{
					alert("Kindly enter valid  pincode..");
					document.frmsellreg.pincode.focus();
					return false;
				}
		...
		else if(!document.frmsellreg.contactnumber.value.match(numericExpression))
			{
			...
			else if(!document.frmsellreg.mbnumber.value.match(numericExpression))
			{
	  ...
	  function validate3(){
		 ...
		 if(document.frmsellreg.password.value.length < 8)
				{
