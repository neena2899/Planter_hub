...
<form method="post" action="payment.php" name="frmcstdetail" onSubmit="return validatecstdetail()">
			...
			for($icount=0; $icount < count($_POST['buyingproduct']); $icount++)
			{
				echo "<input type='hidden' name='buyingproduct[]' value='$buyingproduct[$icount]' >";
				  ...
				  echo "
						...
						$i++;
						$tot = $_SESSION['gtotal'] = $tot + ( $rs['cost'] * $rs['quantity'] );
...
?>
	...
	PIN Code <font color="#FF0000">*</font>
	  <input type="text" name="cstpincode" id="cstpincode" value="" autofocus class="form-control" >
	</div>	
	<div class="col-md-12 form-group">
