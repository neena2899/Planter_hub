...
$msgtocustomer = "You have sent purchase request for - $rsproduct[title]. To check the quality of the produce, you can contact $rsseller[seller_name] at $rsseller[mobile_no]. Farmer's Address: $rsseller[seller_address], $rs13city[city], $rs12state[state].  ";
...
<div class="form-row">
	...
	<div class="col-md-6 form-group">
		Request Date<font color="#FF0000">*</font> <font color="#FF0000"> </font>
		<input type="date" name="requestdate" id="requestdate" readonly value="<?php echo date("Y-m-d"); ?>" class="form-control">
	</div>
	
	<div class="col-md-6 form-group">
		Expiry Date<font color="#FF0000">*</font> <font color="#FF0000"> </font>
