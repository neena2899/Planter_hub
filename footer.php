  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-contact">
            ...
            <p>
              KOTTAYAM<br>
              KERALA, India <br><br>
              <strong>Phone:</strong> +91-839920283<br>
              <strong>Email:</strong> info@planterhub.com<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>PLANTER HUB</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          Developed By NEENA SOMAR
        </div>
      </div>
