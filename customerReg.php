...
if(isset($_POST['submit']))
{
	...
	{
		$sql="INSERT INTO `customer`( `customer_name`, `address`, `state_id`, `city_id`, `pincode`, `contact_no`, `mobile_no`, `email_id`, `password`, `customer_type`, `status`) VALUES ('$_POST[customername]','$_POST[address]','$_POST[state]','$_POST[city]','$_POST[pincode]','$_POST[cntctnum]','$_POST[mblnum]','$_POST[email_id]','$_POST[password]','$_POST[customertype]','$_POST[status]')";	
		if(!mysqli_query($con,$sql))
		{
            ...
            <div class="row">
              ...
              <div class="col-md-3 d-flex align-items-stretch mt-4 mt-lg-0">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="200" style="width: 100%;">
				  ...
				  <img src="images/icon3.png" style="width: 100%;">
                </div>
              </div>
...
<script type="application/javascript">
	  ...
	  function validate1()
	  {
		...
		if(document.frmcstreg.customername.value == "")
		  ...
		  else if(document.frmcstreg.customername.value == 'null')
				{
					alert("customer  name should not be empty");
					document.frmcstreg.customername.focus();
					return false;
	  ...
	  function validate2()
	  {
		...
		if(select2.value==null)
				...
				else if(!document.frmcstreg.pincode.value.match(numericExpress))
				{
		...
		else if(!document.frmcstreg.cntctnum.value.match(numericExpression))
			{
			...
			else if(!document.frmcstreg.mblnum.value.match(numericExpression))
			{
	  ...
	  function validate3(){
		 ...
		 if(document.frmcstreg.password.value.length < 8)
				{
