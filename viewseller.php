  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container">
		...
		<center><h4>Registered Planters  list...</h4></center><hr>
...
<?php
						    ...
						    <tr>
						      ...
						      <td>&nbsp;$rs[status]</td>
						      <td>&nbsp;  <a href='seller.php?editid=$rs[seller_id]' class='btn btn-info'>Edit</a>  <a href='viewseller.php?deleteid=$rs[seller_id]' onclick='return delconfirm()' class='btn btn-danger'>Delete</a></td>
					        </tr>";
							  }
							  ?>
								</TBODY>
